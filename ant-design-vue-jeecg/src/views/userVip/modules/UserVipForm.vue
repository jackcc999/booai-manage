...
import IdAndName from '@/components/IdAndName'
    ...
    data () {
        return {
            ...
            validatorRules: {
                ...
                vipId: [
                    { required: true, message: '请选择VIP!'},
                ],
            },
            url: {
                add: "/manage/userVip/add",
                edit: "/manage/userVip/edit",
                queryById: "/manage/userVip/queryById"
            }
        }
    },
    computed: {
