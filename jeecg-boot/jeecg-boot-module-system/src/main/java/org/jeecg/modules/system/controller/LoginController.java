...
import cn.com.dgwl.tools.v2.encrypt.Rsa;
import cn.com.dgwl.tools.v2.exception.BizException;
import cn.com.dgwl.tools.v2.net.Ipv4;
import cn.com.dgwl.tools.v2.util.Base64Util;
import cn.com.dgwl.tools.v2.util.IntUtil;
...
public class LoginController
{
    ...
    public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel)
    {
		...
		try
		{
			username = Rsa.decrypt(Base64Util.safeBase64Decode(username), loginPrivateKey);
			password = Rsa.decrypt(Base64Util.safeBase64Decode(password), loginPrivateKey);
		}
		catch(Exception e)
		{
			// TODO: loginCheckBiz.recordUserLoginFailNum("rsa-null", Ipv4.getRemoteIp());
		...
		// TODO: loginCheckBiz.checkUserLogin(username, Ipv4.getRemoteIp());
		...
		try
		{
			...
			{
				// TODO: throw new BizException(loginCheckBiz.recordUserLoginFailNum(username, Ipv4.getRemoteIp()));
				throw new BizException("用户名或密码错误");
			}
		}
		catch(Exception e)
