...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
    ...
    public Result<?> resetPassword(String username, String oldpassword, String newpassword, String confirmpassword) {
        ...
        String passwordEncode = PasswordUtil.encrypt(oldpassword, user.getSalt());
        ...
        String password = PasswordUtil.encrypt(newpassword, user.getSalt());
	...
	public SysUser selectUserById(String userId) {
		...
		List<SysDepart> departs = sysDepartMapper.queryUserDeparts(userId);
		if(departs!=null && departs.size()>0){
			sysUser.setDept(departs.get(0));
		}
...
//		this.save(user);  //保存角色的时候已经添加过一次了
    ...
    {
        return sysUserMapper.getSysUserListByRoleCode(roleCode);
    }
}
